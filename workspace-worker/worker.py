...
Each variation needs: variation_id, variation_name, ebay_title (80 char max), price_usd, filament, colors_used, estimated_print_time_hours, estimated_filament_grams, estimated_filament_cost_usd, units_per_plate, batch_plan, machine_hours_per_unit, revenue_per_machine_hour, item_specifics, search_keywords, notes_for_joshua.
